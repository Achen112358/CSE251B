...
#train_ataset_rotate = TASDataset('tas500v1.1', transform_mode=['rotate'])
...
model_name = 'fcn_latest_model_p4b_lr2.pt'
...
normedWeights = [1.72620123, 0.48947504, 3.18976096, 4.71234815, 2.28639652, 4.98026759, 6.53722305, 8.74428468, 3.04187039, 6.84032097]
normedWeights = list(np.array(normedWeights) / np.sum(normedWeights))
normedWeights = torch.FloatTensor(normedWeights).to(device)
criterion = nn.CrossEntropyLoss(normedWeights) # Choose an appropriate loss function from 
